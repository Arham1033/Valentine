...
const page = () => {
 const [loading, setLoading] = useState(true); // 👈 key change
    ...
    <>
      ...
      style={{
        backgroundImage: loading
          ? "url('/v4.jpg')" // background during loading
          : "url('/v13.webp')",    // background after loading
    ...
    >
      {loading ? (
        <div className="flex flex-col items-center justify-center animate-fadeIn">
          <img src="/gif10.gif" alt="GIFs ahead" className="md:w-100 w-80 mb-6" />
          <h2 className="sm:text-2xl text-xl font-semibold text-pink-400 mb-4 valentine-text2 text-stroke1 tracking-wider">Gifts upcoming wait... 😴</h2>
          {/* Loading bar */}
          <div className="w-64 h-4 bg-pink-300 rounded-full overflow-hidden">
            <div
        ...
        <div className="flex flex-col items-center justify-center w-full h-full md:p-10 relative">
          ...
          <div className="gift flex gap-6 animate-fadeIn">
...
<img onClick={() => router.push("/gift3")} className='hover-pointer sm:w-25 w-20 h-20 sm:h-25 sm:mt-8 mt-6' src="/gif15.gif" alt=""/>
          ...
          <button onClick={() => router.push("/next")} className="bg-pink-600 text-pink-300
    ...
    group animate-fadeIn hover:scale-105">
